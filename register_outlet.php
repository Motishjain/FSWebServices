...
if(
(!empty($name)) and (!empty($alias_name)) and (!empty($address_line1)) and (!empty($address_line2)) and 
    (!empty($pincode)) and (!empty($email)) and (!empty($mobile_number)) and (!empty($outlettype))
)
{
    $not_to_insert=False;
